...
[AQS](Java/Java基础/Java并发与多线程.md#五JUC包核心与算法)

## 12、线程池

[JDK线程池](Java/Java基础/Java并发与多线程.md#六线程池)
...
[Redis持久化](Java/Java架构/Redis与Memcached.md#三Redis持久化)

## 2、Redis集群

[Redis cluster](Java/Java架构/Redis与Memcached.md#7RedisCluster)

## 3、Redis内存模型

[Redis内存模型](Java/Java架构/Redis与Memcached.md#六Redis内存模型)
...
[分布式缓存](Java/Java架构/分布式.md#六分布式缓存)

## 2、分布式事务

[分布式事务](Java/Java架构/分布式.md#三分布式事务)

# 十二、zookeeper

## 1、zookeeper核心原理

[zookeeper核心原理](Java/Java架构/分布式.md#9zookeeper核心原理)

# 十三、MQ

## 1、RocketMQ消息消费

[RocketMQ消息消费](Java/Java架构/消息队列/RocketMQ.md#三、RocketMQ消息消费)
