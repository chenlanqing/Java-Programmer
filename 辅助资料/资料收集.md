...
- [Professional PDF Tools](https://github.com/PDFCraftTool/pdfcraft)
...
###  IP黑名单与安全检测（Block Status）

|网站|功能说明|
| ---- | ---- |
|whatismyipaddress.com|提供多个数据库的IP黑名单状态列表，确认IP是否被封锁。|
|dnschecker.org|检查IP是否出现在各类DNS黑名单(DNSBL)中，并提供状态报告。|

### IP归属地与详细信息分析（Registrar, Location, Type）

|网站|功能说明|
| ---- | ---- |
|ip2location.com|提供详细的IP地理位置、ISP供应商、域名、连接类型及代理信息。|
|scamanalytics.com|分析IP欺诈风险，评估是否为代理/VPN，包含ISP和位置信息。|
|ping0.cc|提供IP详情，如ASN、ISP、地理位置，并识别是否为机房(数据中心)IP。|
...
- H3 空间索引：https://h3geo.org/docs/api/indexing
...
中文和英文之间的空格：https://github.com/vinta/pangu.js
...
- [用于数学解释视频的动画引擎](https://github.com/3b1b/manim)
...
- [免费 API 列表](https://github.com/public-apis/public-apis)
...
- [YT-DLP 是一款功能丰富的命令行音频/视频下载器](https://github.com/yt-dlp/yt-dlp)
...
- [CRM](https://github.com/1Panel-dev/CordysCRM)
...
- [Plane 是一个现代化的项目管理平台，用于管理任务、冲刺、文档和分诊](https://github.com/makeplane/plane)
- [5个高星开源知识库神器](https://mp.weixin.qq.com/s/-3WQxTYn_pbmh7TllZ2vlQ)
- https://github.com/readur/readur

## 7、总结

https://yearcompass.com/cn/
...
- [RSS reader for macOS and iOS.](https://github.com/Ranchero-Software/NetNewsWire):https://gist.github.com/emschwartz/e6d2bf860ccc367fe37ff953ba6de66b
- [后端开发常用框架文档及中文翻译](https://github.com/docs4dev/docs4dev)
- [实时且热门资讯列表页](https://github.com/ourongxing/newsnow)
...
- [汇集顶级编程、人工智能、产品、科技文章](https://github.com/ginobefun/BestBlogs)
- [一个基于 Cloudflare Workers 驱动的内容聚合与生成平台](https://github.com/justlovemaki/CloudFlare-AI-Insight-Daily)
...
- [跨平台互动桌宠 BongoCat，为桌面增添乐趣！](https://github.com/ayangweb/BongoCat)