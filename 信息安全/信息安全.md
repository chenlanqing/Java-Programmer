...
- https://zread.ai
- [Find secrets with Gitleaks](https://github.com/gitleaks/gitleaks)
- [Find, verify, and analyze leaked credentials](https://github.com/trufflesecurity/trufflehog)

# 代码扫描

- [Semgrep 是一款快速、开源的静态分析工具](https://github.com/semgrep/semgrep)

# AI 与安全

- [开源 AI 黑客](https://github.com/usestrix/strix)
- [Shannon: 完全自主的 AI 黑客，帮你发现网页应用中的实际漏洞](https://github.com/KeygraphHQ/shannon)

# 网络扫描

- [Flowsint 是一款开源的开源 OSINT 图探索工具，动挖出关联域名、数据泄露记录、社交账号](https://github.com/reconurge/flowsint)

# 参考资料

- [安全研究人员和渗透测试者的一体化黑客工具](https://github.com/Z4nzu/hackingtool)
...
- [网络安全人工智能](https://github.com/aliasrobotics/cai)
- [网络安全职业路径](https://github.com/rezaduty/cybersecurity-career-path)