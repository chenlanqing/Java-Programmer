 ...
 * http://blog.csdn.net/pfnie/article/category/7161421
 */
签名:public abstract class AbstractQueuedSynchronizer extends AbstractOwnableSynchronizer implements java.io.Serializable{}
一.概述:
...
2.AQS 对外公开的方法不需要子类实现的:
	...
	上述方法都是 final 的.
3.AQS 是基于模板模式的实现,不过其模板模式的实现有些特别,整个类中没有抽象方法,取而代之的是需要子类去实现那些方法通过一个方法体.
