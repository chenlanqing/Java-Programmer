...
7.Javascript数据类型:
	...
	7.4.Object.prototype.toString.apply()
		...
		** 通过{}.toString拿到，适合内置对象和基元类型，遇到null和undefined失效(IE678等返回[object Object])。
		alert(1..toString()); // "1"
8.严格模式:"use strict",严格模式是一种特殊的执行模式,它修复了部分语言上的不足,提供更强的错误检查，并增强安全性
	参考:http://www.imooc.com/article/2214
...
10.数组:值的有序集合.每个值叫做元素,每个元素在数组中都有数字位置编号,也就是索引.
...
11.函数(function):是一块JavaScript代码,被定义一次,但可执行和调用多次.JS中的函数也是对象,所以JS函数可以像其它对象那样操作和传递
	所以我们也常叫JS中的函数为函数对象
