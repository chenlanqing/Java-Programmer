...
6.Javascript异步编程:异步模式有四种方法 [/* http://www.ruanyifeng.com/blog/2012/12/asynchronous%EF%BC%BFjavascript.html */]
...
7.闭包:闭包是指有权访问另外一个函数作用域中的变量的函数,闭包是代码块和创建该代码块的上下文中数据的结合
