...
2.单例模式:单例就是保证一个类只有一个实例，实现的方法一般是先判断实例存在与否，如果存在直接返回，
...
3.观察者模式:【http://www.cnblogs.com/TomXu/archive/2012/03/02/2355128.html】
...
5.建造模式:可以将一个复杂对象的构建与其表示相分离，使得同样的构建过程可以创建不同的表示
