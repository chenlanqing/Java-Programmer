...
- [《独立开发者的艺术》打造最全的独立开发者指南，一人公司](https://github.com/hua1995116/indiehackers-steps)
...
- [InsForge: 专门为 AI 编码代理和 AI 代码编辑器构建的后端开发平台](https://github.com/InsForge/InsForge)
...
* 数据库: [Drizzle ORM](https://orm.drizzle.team/) - 轻量级 ORM 库，类型友好，支持多种数据库
* 鉴权: [Better Auth](https://better-auth.com/) - 全面的鉴权库，支持多种鉴权方式和插件
* 支付: [Stripe](https://stripe.com/) + [Creem](https://creem.io/) - 支付处理平台组合
* 邮件: [React Email](https://react.email/) + [Resend](https://resend.com/) - 邮件发送服务
* 对象存储: [S3](https://aws.amazon.com/s3/) / [R2](https://www.cloudflare.com/r2/) - 云存储服务
* 博客: MDX support with [Fumadocs MDX](https://fumadocs.dev/)
* 文档: [Fumadocs](https://fumadocs.dev/) with search
* 国际化: [Next-intl](https://next-intl-docs.vercel.app/)
* 暗色主题: [Next-themes](https://github.com/pacocoursey/next-themes)
* Analytics: [vanilla-cookieconsent](https://github.com/orestbida/cookieconsent) + GA + [umami](https://umami.is/) + [plausible](https://plausible.io/)
