...
# 四、无头浏览器（Headless Browser）

- [Chrome 浏览器无头模式](https://developer.chrome.com/docs/chromium/headless)
- [Chrome 浏览器驱动](https://googlechromelabs.github.io/chrome-for-testing/)
...
https://www.zhihu.com/question/46891356

# 七、自学

- [每个软件开发人员都应该了解的（大部分）技术知识的集合](https://github.com/mtdvio/every-programmer-should-know)
...
- [大学生必备的「资源百宝箱」](https://github.com/dipakkr/A-to-Z-Resources-for-Students)